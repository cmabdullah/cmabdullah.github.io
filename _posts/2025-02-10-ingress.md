---
title: "Ingress: Routing External Traffic (Kubernetes Internals #25)"
header:
...
---
*Kubernetes Internals series, Part 25.*
*← Previous: [Services](/devops/k8s-services/) · Next: [NetworkPolicy](/devops/network-policy/) →*
