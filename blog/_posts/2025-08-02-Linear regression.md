...
Using parentheses: \( f(x) = x^2 + 2x + 1 \)

Using brackets: \[ \lim_{x \to \infty} \frac{1}{x} = 0 \]
...
$$
w = \frac{256250 - 255000}{723750 - 722500}
$$
...
<span class="result-equation">$$
\text{weight} = 1 \cdot \text{height} + (-110)
$$</span>

or simplified:

$$
\text{weight} = \text{height} - 110
$$
...
<p>Test: <span>$x = 5$</span> end.</p>

<ul>
<li><span>$n = 5$</span></li>
<li><span>$\sum x_i = 850$</span></li>
</ul>

<span style="display: inline-block;">$$n = 5$$</span>



<ul>
<li><span style="display: inline-block;">$$n = 5$$</span></li>
<li><span style="display: inline-block;">$$\sum x_i = 850$$</span></li>
<li><span style="display: inline-block;">$$\sum y_i = 300$$</span></li>
<li><span style="display: inline-block;">$$\sum x_i y_i = 51250$$</span></li>
<li><span style="display: inline-block;">$$\sum x_i^2 = 144750$$</span></li>
</ul>
